...
@Component({
  selector: 'app-system-interactions',
  templateUrl: './system-interactions.component.html',
  styleUrls: ['./system-interactions.component.scss']
})
export class SystemInteractionsComponent implements OnInit {
  activeTab: string;
