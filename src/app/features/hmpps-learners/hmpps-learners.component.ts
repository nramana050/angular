...
@Component({
  selector: 'app-hmpps-learners',
  templateUrl: './hmpps-learners.component.html',
  styleUrls: ['./hmpps-learners.component.scss']
})
export class HmppsLearnersComponent  implements OnInit , AfterViewInit {
