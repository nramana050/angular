...
@Component({
  selector: 'app-mentivity-learners',
  templateUrl: './mentivity-learners.component.html',
  styleUrls: ['./mentivity-learners.component.scss']
})
export class MentivityLearnersComponent implements OnInit {
  ...
  addParticipant(){
    this.router.navigate(['mentivity-learner/new']);
  }
