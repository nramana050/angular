...
export class TranslatePopupComponent implements OnInit {
 ...
 async ngOnInit(): Promise<void> {
  ...
  getSelectedLanguagesData(){
      this.genaieService.selectedLanguagesData(this.courseId).subscribe(languages=>{
  ...
  getLanguageRefData(){
    return new Promise(resolve=>{
      this.genaieService.getLaunguage().subscribe(res=>{
        res.shift();
  ...
  generateLanguages(){
    ...
    this.genaieService.generateLanguages(payload).subscribe(res=>{
