...
export class MyUploadAdapter {
    ...
    constructor(private data, private courseId, private GenaieService: GenaieService, private snackBarService : SnackBarService) {}
    upload() {
            ...
            return new Promise((resolve, reject) => {
              ...
              if(this.validFileType(file)){
                if (file && !this.validFileSize(file)) {
                  this.GenaieService.getSasUrl(this.courseId, file.name).subscribe(res=>{
