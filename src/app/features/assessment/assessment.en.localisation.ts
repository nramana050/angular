...
@Injectable()
export class AssessmentsCustomLocalisations {
    enUKStrings = {
        // assessment templates
        survey: {
            edit: 'Edit',
            dropQuestion: 'Your question here.',
            copy: 'Copy',
        ...
        ed: {
            ...
            newPanelName: 'panel',
            testSurvey: 'Test Assessment',
            testSurveyAgain: 'Test Assessment Again',
            testSurveyWidth: 'Assessment width: ',
            embedSurvey: 'Embed Assessment',
            saveSurvey: 'Save',
            designer: 'Asset',
            ...
            surveyResults: 'Assessment Result: ',
            modified: 'Modified',
            saving: 'Saving',
            saved: 'Saved',
        ...
        pe: {
            ...
            conditionHelp: 'Please enter a boolean expression. It should return true to keep the question/page visible.' +
            ' For example: {question1} = \'value1\' or ({question2} * {question4}  > 20 and {question3} < 5)',
            expressionHelp: 'Please enter an expression. You may use curly brackets to get access to the question values:' +
            ...
            surveyEditorTitle: 'Edit assessment settings',
            qEditorTitle: 'Edit: {0}',
            ...
            cookieName: 'Cookie name (to disable run assessment two times locally)',
            sendResultOnPageNext: 'Send assessment results on page next',
            ...
            firstPageIsStarted: 'The first page in the assessment is a started page.',
            ...
            maxTimeToFinish: 'Maximum time to finish the assessment',
            maxTimeToFinishPage: 'Maximum time to finish a page in the assessment',
            ...
            noquestions: 'There is no any question in the assessment.',
            createtrigger: 'Please create a trigger',
            triggerOn: 'On ',
            triggerMakePagesVisible: 'Make pages visible:',
            triggerMakeQuestionsVisible: 'Make elements visible:',
            triggerCompleteText: 'Complete the assessment if succeed.',
            ...
            triggerSetValue: 'to: ',
            triggerIsVariable: 'Do not put the variable into the assessment result.'
        },
        // Property values
        pv: {
            true: 'true',
        ...
        ew: {
            ...
            showOnPage: 'Show assessment on a page',
            showInWindow: 'Show assessment in a window',
            loadFromServer: 'Load Assessment JSON from server',
        ...
        triggers: {
            completetrigger: 'complete assessment',
