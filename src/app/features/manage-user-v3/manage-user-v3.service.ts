...
export class ManageUserV3Service {
  ...
  createUser(payload) {
    return this.http.post<any>(`${BaseUrl.USER}/manage-user-v3`, payload);
  }
  ...
  getUserDetails(id) {
    const href = `${BaseUrl.USER}/manage-user-v3/${id}`;
    return this.http.get<any>(href);
  }


  updateUser(payload) {
    return this.http.put(`${BaseUrl.USER}/manage-user-v3`, payload, { responseType: 'text' });
  }
  ...
  deleteUser(payload) {
    const href = `${BaseUrl.USER}/manage-user-v3/deleteUser`;
  ...
  getContractData(){
    const href = `${BaseUrl.USER}/manage-user-v3/contracts`;
    return this.http.get<any>(href);
  }
